...
module.exports = {
    ...
    async execute (interaction, client) {
        ...
        \n - **/buttonrole** - **__Button Based Role Command__** - To use this command simply enter the slash command and enter what roles you want underneath the message.
        \n - **/reactionrole** - **__Reaction Based Role Command__** - To use this command simply enter....`)
